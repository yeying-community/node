...
| POST | `/api/v1/public/identity/credentials/reissue/challenge` | 为已验证邮箱/用户名凭证创建自动续签 challenge |
| POST | `/api/v1/public/identity/credentials/reissue/confirm` | 校验身份 controller proof 并重签短期 JWT-VC |
