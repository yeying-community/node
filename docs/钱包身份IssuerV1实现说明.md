...
| POST | `/api/v1/public/identity/verifications/request` | 请求邮箱/用户名/头像验证 |
| POST | `/api/v1/public/identity/verifications/confirm` | 签发 `EmailCredential` / `UsernameCredential` / `AvatarCredential` |
