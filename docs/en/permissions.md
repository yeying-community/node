...
2. **Ownership checks**: only owners can update/offline their apps/services.
3. **Audit permissions**: only reviewers/admins can approve/reject; record approver identity.
...
6. **Online state constraints**: require audit pass before online; search should default to online only.
