...
const document = {
  ...
  tags: Object.entries({
    ...
    Pusher: 'Node Pusher 原生 publish、SSE subscribe 和通用 channel ACL。',
...
const operations = [
  ...
  ['get', '/api/v1/public/applications/{uid}/releases', 'Applications', '查询应用版本列表', 'bearer'],
  ['get', '/api/v1/public/applications/{uid}/releases/{version}', 'Applications', '查询指定应用版本', 'bearer'],
  ['post', '/api/v1/public/applications/{uid}/releases/{version}/withdraw', 'Applications', '撤回指定应用版本', 'bearer', 'SignedActionFields'],
  ...
  ['get', '/api/v1/public/applications/{uid}/pusher/credentials', 'Applications', '查询应用 Pusher 凭据元数据', 'bearer'],
  ['post', '/api/v1/public/applications/{uid}/pusher/credentials', 'Applications', '创建应用 Pusher 凭据', 'bearer'],
  ['post', '/api/v1/public/applications/{uid}/pusher/credentials/rotations', 'Applications', '轮换应用 Pusher 凭据', 'bearer'],
  ...
  ['get', '/api/v1/admin/pusher/channel/acls', 'Pusher', '列出 Pusher 频道 ACL', 'bearer'],
  ['post', '/api/v1/admin/pusher/channel/acls', 'Pusher', '写入 Pusher 频道 ACL', 'bearer'],
  ['get', '/api/v1/admin/mail/settings', 'Mail', '查询邮件配置状态', 'bearer'],
  ['post', '/api/v1/admin/mail/tests', 'Mail', '发送测试邮件', 'bearer'],
  ['get', '/api/v1/admin/mail/templates', 'Mail', '列出 Email 模板', 'bearer'],
  ['post', '/api/v1/admin/mail/templates', 'Mail', '创建 Email 模板', 'bearer'],
  ['patch', '/api/v1/admin/mail/templates/{templateId}', 'Mail', '更新 Email 模板', 'bearer'],
