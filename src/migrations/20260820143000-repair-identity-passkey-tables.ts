...
export class RepairIdentityPasskeyTables20260820143000 implements MigrationInterface {
  name = 'RepairIdentityPasskeyTables20260820143000'

  async up(queryRunner: QueryRunner): Promise<void> {
    if (queryRunner.connection.options.type !== 'postgres') throw new Error('RepairIdentityPasskeyTables20260820143000 only supports postgres')
  ...
  async down(): Promise<void> {
    // Intentionally retained; this is a drift repair migration.
  }
}
